...
const nogfsopb = {};
addProto(nogfsopb, 'nogfso', 'proto/nogfsopb/gitnog.proto');
addProto(nogfsopb, 'nogfso', 'proto/nogfsopb/gitnogtree.proto');
addProto(nogfsopb, 'nogfso', 'proto/nogfsopb/registry.proto');
addProto(nogfsopb, 'nogfso', 'proto/nogfsopb/repos.proto');
addProto(nogfsopb, 'nogfso', 'proto/nogfsopb/stat.proto');
addProto(nogfsopb, 'nogfso', 'proto/nogfsopb/broadcast.proto');
addProto(nogfsopb, 'nogfso', 'proto/nogfsopb/discovery.proto');
addProto(nogfsopb, 'nogfso', 'proto/nogfsopb/tartt.proto');

const unixdomainspb = {};
addProto(
  unixdomainspb, 'unixdomains', 'proto/unixdomainspb/unix-domain.proto',
);

// Export full proto as `nogfsopb` and selected details by name.
const {
  GitNog,
  GitNogTree,
  Registry,
...
const {
  TAR_FULL,
  TAR_PATCH,
} = nogfsopb.TarInfo.TarType.values;
